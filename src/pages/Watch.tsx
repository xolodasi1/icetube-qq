  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex-1 lg:w-[70%]">
        ...
        <div className="w-full aspect-video bg-black rounded-xl overflow-hidden border ice-border shadow-2xl relative">
          <video 
            autoPlay 
            controls 
        ...
        <div className="mt-4 flex flex-col gap-3">
          ...
          <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="ml-2 bg-slate-100 text-cold-bg hover:bg-slate-300 font-medium px-4 py-2 rounded-full transition-colors text-sm">
                Subscribe
              </button>
            </div>
            ...
            <div className="flex items-center gap-2 overflow-x-auto pb-2 sm:pb-0 hide-scrollbar">
              <div className="flex items-center bg-white/5 border ice-border rounded-full overflow-hidden shrink-0 cursor-pointer text-slate-300">
                <button className="flex items-center gap-2 px-4 py-2 hover:bg-[rgba(112,214,255,0.08)] hover:text-[#70d6ff] transition-colors border-r ice-border text-sm">
                  <ThumbsUp className="w-4 h-4" />
                  <span>24K</span>
                </button>
                <button className="px-4 py-2 hover:bg-[rgba(112,214,255,0.08)] hover:text-[#70d6ff] transition-colors text-sm">
        ...
        {/* Description Box */}
        <div className="mt-4 bg-white/5 border ice-border p-4 rounded-xl text-sm">
        ...
        <div className="mt-8 mb-10">
          ...
          <div className="mt-8 flex flex-col gap-6">
            {/* Dummy Comment 1 */}
            <div className="flex gap-4">
              <img src="https://picsum.photos/seed/c1/100/100" className="w-10 h-10 rounded-full shrink-0 object-cover" alt="User 1" />
              <div className="flex-1">
                <div className="flex items-center gap-2 text-xs mb-1">
                  <span className="font-medium text-slate-200">@FrostByte22</span>
                  <span className="text-slate-500">2 hours ago</span>
                </div>
                <p className="text-sm text-slate-300 mb-2">The editing in this video is absolutely chilling... I love it! The icy aesthetic really suits the channel.</p>
                <div className="flex items-center gap-4 text-slate-400">
                  <button className="flex items-center gap-1.5 hover:text-white transition-colors"><ThumbsUp className="w-4 h-4" /> 142</button>
            ...
            {/* Dummy Comment 2 */}
            <div className="flex gap-4">
              <img src="https://picsum.photos/seed/c2/100/100" className="w-10 h-10 rounded-full shrink-0 object-cover" alt="User 2" />
              <div className="flex-1">
                <div className="flex items-center gap-2 text-xs mb-1">
                  <span className="font-medium text-slate-200">@IceExplorer</span>
                  <span className="text-slate-500">1 day ago</span>
                </div>
                <p className="text-sm text-slate-300 mb-2">Icetube 2.0 is looking very sleek. Glad we have a true dark mode platform now.</p>
                <div className="flex items-center gap-4 text-slate-400">
                  <button className="flex items-center gap-1.5 hover:text-white transition-colors"><ThumbsUp className="w-4 h-4" /> 89</button>
                  <button className="flex items-center gap-1.5 hover:text-white transition-colors"><ThumbsDown className="w-4 h-4" /></button>
                  <button className="text-xs font-medium hover:text-white transition-colors">Reply</button>
                </div>
              </div>
