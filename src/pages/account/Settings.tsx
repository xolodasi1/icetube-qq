          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">{t('settings_theme_desc')}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">{t('settings_lang_desc')}</p>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="bg-white/5 border ice-border rounded-2xl p-6 transition-all hover:bg-white/[0.07]">
      ...
      <p className="text-xs text-slate-500 text-center sm:text-left">
        {language === 'ru' ? 'Последняя версия установлена.' : 'Latest version installed.'}
      </p>
    </div>
  );
}
